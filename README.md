...
[Открыть опубликованную версию](https://teaboom-card.vercel.app/)
...
Автор: Игорь Бочаров (Fullstack-разработчик).

Репозиторий: [github.com/i-bocharov/teaboom-card](https://github.com/i-bocharov/teaboom-card).

Использование исходного кода или его отдельных частей допускается с указанием ссылки на оригинальный репозиторий.